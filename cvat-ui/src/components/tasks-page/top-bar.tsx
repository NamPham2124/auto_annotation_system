                ...
                <div className='cvat-tasks-page-filters-wrapper'>
                    ...
                    <div>
                        <SortingComponent
                            ...
                            sortingFields={['ID', t('tasks.owner'), t('tasks.status'), t('tasks.assignee'), t('tasks.updatedDate'), t('tasks.subset'), t('tasks.mode'), t('tasks.dimension'), t('tasks.projectId'), t('tasks.name'), t('tasks.projectName')]}
