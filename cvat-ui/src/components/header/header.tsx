...
function HeaderComponent(props: Props): JSX.Element {
    ...
    menuItems.push([{
        ...
        children: [
            ...
            ...(!!organizationsList && viewType === 'menu' ? [{
                ...
                key: '$personal',
                label: t('common.personalWorkspace'),
    ...
    menuItems.push([{
        ...
        title: t('header.pressShortcutToSwitch', { shortcut: switchSettingsShortcut }),
        label: t('common.settings'),
    }, 30]);
    ...
    return (
        <Layout.Header className='cvat-header'>
            ...
            <div className='cvat-right-header'>
                <CVATTooltip overlay={t('header.clickToOpenRepository')}>
                    <Button
                        icon={<GithubOutlined />}
                        size='large'
                ...
                <CVATTooltip overlay={t('header.clickToOpenGuide')}>
                    <Button
