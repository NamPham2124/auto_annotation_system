    ...
    return (
        ...
        >
            ...
            <span
                ...
                onClick={collapse}
            >
                {sidebarCollapsed ? <MenuFoldOutlined title={t('annotation.show')} /> : <MenuUnfoldOutlined title={t('annotation.hide')} />}
            </span>
            ...
            <Tabs
                ...
                items={[{
                    key: 'objects',
                    label: t('annotation.objects'),
                    children: objectsList,
                }, {
                    key: 'labels',
                    label: t('annotation.labels'),
                    forceRender: true,
                    children: <LabelsList />,
                }, ...(is2D ? [{ key: 'issues', label: t('annotation.issues'), children: <IssuesListComponent /> }] : [])]}
            />
