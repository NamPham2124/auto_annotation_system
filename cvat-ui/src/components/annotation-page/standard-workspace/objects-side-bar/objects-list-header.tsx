...
function LockAllSwitcher(props: Props): JSX.Element {
    ...
    return (
        <Col span={3}>
            <CVATTooltip title={t('annotation.switchLockAll', { shortcut: switchLockAllShortcut })}>
...
function HideAllSwitcher(props: Props): JSX.Element {
    ...
    return (
        <Col span={3}>
            <CVATTooltip title={t('annotation.switchHiddenAll', { shortcut: switchHiddenAllShortcut })}>
                {statesHidden ? (
...
function GTSwitcher(props: Props): JSX.Element {
    ...
    return (
        <Col span={3}>
            <CVATTooltip title={t('annotation.showGroundTruth')}>
                <Icon
                    className={
...
function CollapseAllSwitcher(props: Props): JSX.Element {
    ...
    return (
        <Col span={3}>
            <CVATTooltip title={t('annotation.expandCollapseAll')}>
                {statesCollapsed ? (
    ...
    return (
        <div className='cvat-objects-sidebar-states-header'>
            <Row justify='space-between' align='middle'>
                <Col span={24}>
                    <Text>{t('annotation.items', { count })}</Text>
