            ...
            items={[{
                label: (
                    <Text strong className='cvat-objects-appearance-collapse-header'>
                        {t('annotation.appearance')}
                    </Text>
                ),
                key: 'appearance',
                children: (
                    <div className='cvat-objects-appearance-content'>
                        <Text type='secondary'>{t('annotation.colorBy')}</Text>
                        <Radio.Group
                        ...
                        <Text type='secondary'>{t('annotation.opacity')}</Text>
                        <Slider
                            ...
                            max={100}
                        />
                        <Text type='secondary'>{t('annotation.selectedOpacity')}</Text>
                        <Slider
                        ...
                        {is3D && (
                            <div className='cvat-appearance-cuboid-orientation-checkboxes'>
                                ...
                                >
                                    {t('annotation.cuboidOrientation')}
                                </Checkbox>
                            </div>
                        )}
                        {is2D && (
