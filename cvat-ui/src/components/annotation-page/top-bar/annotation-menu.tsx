...
function AnnotationMenuComponent(): JSX.Element {
    ...
    const finishJob = useCallback(() => {
        dispatch(finishCurrentJobAsync(() => {
            message.open({
                duration: 1,
                type: 'success',
                content: t('annotation.finishJobConfirm'),
    ...
    const changeJobState = useCallback((state: JobState) => () => {
        Modal.confirm({
            title: t('annotation.updateJobState'),
            content: t('annotation.jobStateWillBeSwitched', { state }),
            okText: t('annotation.continue'),
    ...
    menuItems.push([{
        ...
        onClick: () => {
            ...
            Modal.confirm({
                title: t('annotation.removeAnnotationsFromClient'),
                content: (
                    <div>
                        <Text>{t('annotation.removeAnnotations')}</Text>
                        <Text>{t('annotation.stayOnServer')}</Text>
                        <br />
                        <Collapse
                            bordered={false}
                            items={[{
                                ...
                                children: (
                                    <>
                                        ...
                                        />
                                        <CVATTooltip title={t('annotation.applicableOnly')}>
                                            <br />
                                            <br />
                                            <Checkbox
                                                onChange={(check) => {
                                            ...
                                            >
                                                {t('annotation.deleteOnlyKeyframes')}
                                            </Checkbox>
                                        </CVATTooltip>
                                    </>
                                ),
    ...
    menuItems.push([{
        ...
        onClick: () => {
            Modal.confirm({
                title: t('annotation.finishJobTitle'),
                content: t('annotation.finishJobContent'),
                okText: t('annotation.continue'),
                cancelText: t('common.cancel'),
