...
function PlayerNavigation(props: Props): JSX.Element {
    ...
    const showDeleteFrameDialog = useCallback(() => {
        if (!playing) {
            ...
            Modal.confirm({
                title: t('annotation.deleteFrameTitle', { frameNumber }),
                content: t('annotation.deleteFrameContent'),
    ...
    const deleteFrameIcon = !frameDeleted ? (
        <CVATTooltip title={`${t('annotation.deleteFrame')} ${deleteFrameShortcut}`}>
            <DeleteOutlined
        ...
        <CVATTooltip title={t('annotation.restoreFrame')}>
            <Icon
                style={deleteFrameIconStyle}
    ...
    return (
        <>
            ...
            <Col className='cvat-player-controls'>
                ...
                <Row justify='center'>
                    ...
                    <Col className='cvat-player-frame-actions' offset={1}>
                        <CVATTooltip title={t('annotation.copyFrameFilename')}>
                            <CopyOutlined className='cvat-player-copy-frame-name-icon' onClick={onCopyFilenameIconClick} />
                        </CVATTooltip>
                        <CVATTooltip title={t('annotation.createFrameURL')}>
            ...
            <Col>
                <CVATTooltip title={t('annotation.pressShortcutFocusHere', { shortcut: focusFrameInputShortcut })}>
                    <InputNumber
                        ref={inputFrameRef}
            ...
            <Col className='cvat-player-actions'>
                {
                    showSearchFrameByName && (
                        <CVATTooltip title={`${t('annotation.searchFrameByName')} ${searchFrameByNameShortcut}`}>
                            <SearchOutlined
