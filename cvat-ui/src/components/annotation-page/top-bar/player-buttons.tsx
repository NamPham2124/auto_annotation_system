...
function PlayerButtons(props: Props): JSX.Element {
    ...
    const prevRegularText = t('annotation.goBack');
    const prevFilteredText = t('annotation.goBackFiltered');
    const prevEmptyText = t('annotation.goBackEmpty');
    const prevChapterText = t('annotation.goBackChapter');
    const nextRegularText = t('annotation.goNext');
    const nextFilteredText = t('annotation.goNextFiltered');
    const nextEmptyText = t('annotation.goNextEmpty');
    const nextChapterText = t('annotation.goNextChapter');
    ...
    return (
        <Col className='cvat-player-buttons'>
            ...
            <CVATTooltip title={t('annotation.goToFirstFrame')}>
                <Icon
                    style={navIconStyle}
            ...
            <CVATTooltip title={`${t('annotation.backwardStep')} ${backwardShortcut}`}>
                <Icon
                    style={navIconStyle}
            ...
            {!playing ? (
                <CVATTooltip title={`${t('annotation.play')} ${playPauseShortcut}`}>
                    <Icon
                        style={navIconStyle}
                ...
                <CVATTooltip title={`${t('annotation.pause')} ${playPauseShortcut}`}>
                    <Icon
                        style={navIconStyle}
            ...
            <CVATTooltip title={`${t('annotation.forwardStep')} ${forwardShortcut}`}>
                <Icon
                    style={navIconStyle}
            ...
            <CVATTooltip title={t('annotation.goToLastFrame')}>
                <Icon
                    style={navIconStyle}
