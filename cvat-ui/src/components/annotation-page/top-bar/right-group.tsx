...
const WORKSPACE_LABELS: Record<string, string> = {
    [Workspace.STANDARD]: 'annotation.standard',
    [Workspace.STANDARD3D]: 'annotation.standard3D',
    [Workspace.SINGLE_SHAPE]: 'annotation.singleShape',
    [Workspace.REVIEW]: 'annotation.review',
};
...
function RightGroup(props: Props): JSX.Element {
    ...
    const openGuide = useCallback(() => {
        ...
        jobInstance.guide().then((guide) => {
            ...
            notification.error({
                message: t('annotation.couldNotReceiveGuide'),
