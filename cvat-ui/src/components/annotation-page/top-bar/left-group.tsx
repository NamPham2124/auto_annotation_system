        ...
        <>
            ...
            { saving && (
                <Modal
                    ...
                    footer={[]}
                >
                    <Text>{t('annotation.savingAnnotations')}</Text>
                    <LoadingOutlined />
                </Modal>
            )}
            <Col className='cvat-annotation-header-left-group'>
                ...
                <CVATTooltip overlay={`${t('annotation.undo')}: ${undoAction} ${undoShortcut}`}>
                    <Button
                    ...
                    >
                        ...
                        <span>{t('annotation.undo')}</span>
                    </Button>
                </CVATTooltip>
                <CVATTooltip overlay={`${t('annotation.redo')}: ${redoAction} ${redoShortcut}`}>
                    <Button
                ...
                {includesDoneButton ? (
                    <CVATTooltip overlay={t('annotation.finishDrawing', { shortcut: drawShortcut })}>
                ...
                {includesToolsBlockerButton ? (
                    <CVATTooltip overlay={t('annotation.postponeAlgorithm', { shortcut: switchToolsBlockerShortcut })}>
                        <Button
                            type='link'
