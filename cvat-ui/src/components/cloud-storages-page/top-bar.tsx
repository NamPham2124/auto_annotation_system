        ...
        <Row justify='center' align='middle' className='cvat-cloud-storages-list-top-bar'>
            <Col {...dimensions}>
                <div className='cvat-cloudstorages-page-filters-wrapper'>
                    <div>
                        <Input.Search
                            ...
                            placeholder={t('cloudStorages.searchPlaceholderShort')}
                        />
                    ...
                    <div>
                        <SortingComponent
                            ...
                            sortingFields={['ID', t('cloudStorages.providerType'), t('cloudStorages.updatedDate'), t('cloudStorages.displayName'), t('cloudStorages.resource'), t('cloudStorages.credentialsType'), t('cloudStorages.owner'), t('cloudStorages.description')]}
                ...
                <Button
                    ...
                    icon={<PlusOutlined />}
                >
                    {t('cloudStorages.attachCloudStorage')}
                </Button>
            </Col>
        </Row>
    );
