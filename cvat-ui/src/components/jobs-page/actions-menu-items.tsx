...
export default function JobActionsItems(
    ...
    menuItems.push([{
        key: 'task',
        label: withCount(t('jobs.goToTask'), 'task', `/tasks/${taskId}`),
    ...
    if (projectId) {
        menuItems.push([{
            key: 'project',
            label: withCount(t('jobs.goToProject'), 'project', `/projects/${projectId}`),
    ...
    if (onOpenBugTracker) {
        menuItems.push([{
            ...
            label: withCount(t('jobs.goToBugTracker'), 'bug_tracker'),
    ...
    menuItems.push([{
        ...
        label: withCount(t('jobs.importAnnotations'), 'import_job'),
    ...
    menuItems.push([{
        ...
        label: withCount(t('jobs.exportAnnotations'), 'export_job'),
    ...
    if (onMergeConsensusJob) {
        menuItems.push([{
            ...
            label: withCount(t('jobs.mergeConsensusJob'), 'merge_specific_consensus_jobs'),
    ...
    menuItems.push([{
        ...
        label: <CVATMenuEditLabel>{withCount(t('jobs.assigneeEdit'), 'edit_assignee')}</CVATMenuEditLabel>,
    ...
    menuItems.push([{
        ...
        label: <CVATMenuEditLabel>{withCount(t('jobs.stateEdit'), 'edit_state')}</CVATMenuEditLabel>,
    ...
    menuItems.push([{
        ...
        label: <CVATMenuEditLabel>{withCount(t('jobs.stageEdit'), 'edit_stage')}</CVATMenuEditLabel>,
        disabled: isDisabled('edit_stage'),
    }, 80]);

    menuItems.push([{
        key: 'view-analytics',
        label: withCount(t('jobs.viewAnalytics'), 'view-analytics', `/tasks/${taskId}/jobs/${jobId}/analytics`),
    ...
    if (onDeleteJob) {
        ...
        menuItems.push([{
            key: 'delete',
            onClick: onDeleteJob,
            label: withCount(t('jobs.delete'), 'delete'),
