            ...
            triggerElement={(
                ...
                >
                    <Descriptions column={1} size='small'>
                        ...
                        {job.assignee ? (
                            <Descriptions.Item label={t('jobs.assignee')}>{job.assignee.username}</Descriptions.Item>
                        ) : (
                            <Descriptions.Item label={t('jobs.assignee')}> </Descriptions.Item>
                        )}
                    </Descriptions>
                    <div
