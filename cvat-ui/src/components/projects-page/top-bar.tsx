                ...
                <div className='cvat-projects-page-filters-wrapper'>
                    ...
                    <div>
                        <SortingComponent
                            ...
                            sortingFields={[
                                t('projects.sortingFields.ID'),
                                t('projects.sortingFields.Assignee'),
                                t('projects.sortingFields.Owner'),
                                t('projects.sortingFields.Status'),
                                t('projects.sortingFields.Name'),
                                t('projects.sortingFields.UpdatedDate'),
                            ]}
